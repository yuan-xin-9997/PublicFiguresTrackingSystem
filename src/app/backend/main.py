...
def create_app(config_path: Optional[str] = None) -> FastAPI:
    ...
    def daily_digest_options(
        ...
        return {
            ...
            "event_types": sorted(EVENT_TYPES),
            "information_sources": db.fetch_all(
                "SELECT id,name,type FROM information_sources "
    ...
    def create_daily_digest_rule(
        ...
        try:
            item = save_digest_rule(
                ...
                body.recipients, source_ids=body.source_ids, enabled=body.enabled,
                send_time=body.send_time, window_mode=body.window_mode,
                rolling_hours=body.rolling_hours, send_when_empty=body.send_when_empty,
            )
        except ValueError as exc:
            raise HTTPException(422, str(exc))
        audit(
